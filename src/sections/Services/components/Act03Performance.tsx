...
export const Act03Performance: React.FC<Act03PerformanceProps> = () => {
  ...
  const slides = creatives.map((creativeUrl, idx) => (
    <div key={creativeUrl} className="w-full flex items-center justify-center p-1 sm:p-2">
      <div className="w-full max-w-[320px] sm:max-w-[360px] md:max-w-[380px] lg:max-w-[400px] xl:max-w-[430px] max-h-[50vh] lg:max-h-[55vh] xl:max-h-[58vh] aspect-[4/5] rounded-xl lg:rounded-2xl overflow-hidden bg-brand-dark/95 border border-brand-light/20 shadow-2xl relative group">
        <img
          src={creativeUrl}
  ...
  return (
    <div className="w-full h-full flex flex-col justify-between relative select-none">
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-8 xl:gap-12 items-center my-auto py-1">
        ...
        <div className="lg:col-span-5 xl:col-span-5 flex flex-col gap-3 sm:gap-5 lg:gap-5 xl:gap-6">
          {/* Auxiliary Tags */}
        ...
        <div className="lg:col-span-7 xl:col-span-7 flex items-center justify-center lg:justify-end lg:pl-4 xl:pl-8">
          <div className="w-full max-w-[480px] xl:max-w-[510px]">
